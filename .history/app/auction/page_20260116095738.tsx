...
export default function ModernArtAuction() {
  // Style chung cho khối kính mờ chứa số thứ tự
  const glassNumberContainer = "sticky top-40 flex items-center justify-center w-20 h-24 bg-white/10 backdrop-blur-xl border border-white/20 rounded-2xl shadow-2xl z-20";
  const numberTextStyle = "text-4xl font-black tracking-tighter text-[#f07d44] drop-shadow-md";
  ...
  return (
    <div className="min-h-screen bg-[#fafaf9] text-[#1a1a1a] font-sans selection:bg-[#f07d44] selection:text-white transition-colors duration-500">
      ...
      <section className="relative pt-48 pb-24 px-[5%] max-w-[1600px] mx-auto grid grid-cols-12 gap-8">
        {/* Số 01 với nền kính mờ */}
        <div className="col-span-12 lg:col-span-1 hidden lg:block">
           <div className={glassNumberContainer}>
              <span className={numberTextStyle}>01</span>
           </div>
        </div>
        ...
        <div className="col-span-12 lg:col-span-7 relative z-10">
          ...
          <div className="max-w-xs ml-auto lg:mr-24">
            <p className="text-[10px] uppercase tracking-[0.3em] font-black mb-4 opacity-30">Concept / 01</p>
        ...
        <div className="col-span-12 lg:col-span-4">
          <div className="relative aspect-[3/4] lg:h-[650px] rounded-[3rem] overflow-hidden shadow-2xl group">
            <img 
              ...
              alt="Main Art"
            />
            <div className="absolute top-8 right-8 bg-white/20 backdrop-blur-md border border-white/30 px-5 py-2 rounded-full shadow-lg">
                <span className="text-[10px] font-black uppercase tracking-widest text-white">Tác phẩm tiêu biểu</span>
            </div>
          </div>
        </div>
      </section>

      {/* ================= SECTION 02: COLLECTION (NỀN ẢNH + OVERLAY) ================= */}
      <section className="relative py-32 px-[5%] max-w-[1600px] mx-auto mb-20 overflow-hidden rounded-[5rem] shadow-2xl mx-4">
        {/* Ảnh nền Full-width với Overlay và Blur */}
        ...
        <div className="relative z-10 grid grid-cols-12 gap-8">
            {/* Số 02 với nền kính mờ */}
            <div className="col-span-12 lg:col-span-1 hidden lg:block">
                <div className={glassNumberContainer}>
                   <span className={numberTextStyle}>02</span>
                </div>
            </div>

            <div className="col-span-12 lg:col-span-11 text-white">
                <div className="flex flex-col md:flex-row md:items-end justify-between mb-20 gap-8">
                  ...
                  <button className="flex items-center gap-2 font-bold text-xs uppercase tracking-widest pb-2 border-b-2 border-[#f07d44] hover:gap-6 transition-all">
                    ...
                    <div className="md:col-span-8 group">
                      <div className="relative aspect-[21/9] rounded-[3rem] overflow-hidden border border-white/10 shadow-2xl">
                          ...
                          <div className="absolute top-6 left-6 flex gap-3">
                            <div className="bg-red-500 text-white text-[10px] font-black px-4 py-1.5 rounded-full animate-pulse">LIVE</div>
                          </div>
                      </div>
                      <div className="mt-8 flex justify-between items-end px-4">
                          ...
                          <div className="text-right">
                             <p className="text-[10px] uppercase font-bold opacity-40 mb-1">Giá hiện tại</p>
                             <p className="text-3xl font-black italic">25.4M</p>
                          </div>
                      </div>
                    </div>

                    {/* Info Card - Dark Glass Style */}
                    <div className="md:col-span-4 h-full">
                      <div className="bg-white/5 backdrop-blur-xl border border-white/10 p-12 rounded-[3rem] h-full flex flex-col justify-between shadow-2xl">
                          <div>
                            <h4 className="text-xl font-bold uppercase tracking-widest mb-6">Thông điệp</h4>
                          ...
                          <div className="mt-12">
                            <button className="w-full bg-[#f07d44] text-white py-5 rounded-2xl font-black text-xs uppercase tracking-widest shadow-xl hover:scale-[1.02] transition">
                                Đặt lịch triển lãm
                            </button>
                          </div>
                      </div>
      ...
      <section className="py-32 px-[5%] max-w-[1600px] mx-auto relative">
        <div className="grid grid-cols-12 gap-8">
            {/* Số 03 với nền kính mờ */}
            <div className="col-span-12 lg:col-span-1 hidden lg:block">
                <div className={glassNumberContainer}>
                   <span className={numberTextStyle}>03</span>
                </div>
            </div>
                      ...
                      <div className="lg:col-span-5">
                          ...
                          <div className="grid grid-cols-2 gap-12 mb-12">
                            <div>
                                ...
                                <p className="text-3xl font-black text-slate-900 tracking-tighter">{item.bid}</p>
                            </div>
                            <div>
