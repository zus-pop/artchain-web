...
export default function ModernArtAuction() {
  ...
  const stickyGlassStyle = "sticky top-40 flex items-center justify-center w-20 h-20 lg:w-24 lg:h-24 bg-white/60 backdrop-blur-xl border border-white/40 rounded-[2rem] shadow-sm z-20 ml-auto";
  const numberTextStyle = "text-3xl lg:text-4xl font-black text-[#1a1a1a] opacity-20 tracking-tighter";
    ...
    <div className="min-h-screen bg-[#fafaf9] text-[#1a1a1a] font-sans selection:bg-[#f07d44] selection:text-white">
      ...
      <section className="relative pt-40 pb-20 px-[5%] max-w-[1600px] mx-auto grid grid-cols-12 gap-6">
        ...
        <div className="col-span-12 lg:col-span-1 hidden lg:block">
           <div className={stickyGlassStyle}>
      ...
      <section className="py-32 px-[5%] max-w-[1600px] mx-auto relative">
        <div className="grid grid-cols-12 gap-6">
            ...
            <div className="col-span-12 lg:col-span-11">
                <div className="mb-20 pl-4 lg:pl-0 text-left">
                ...
                {[
                    ...
                    <div key={item.id} className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center border-b border-slate-200 pb-20 last:border-0 px-4 lg:px-0 text-left">
