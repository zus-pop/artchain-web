...
export default function ModernArtAuction() {
  // Định nghĩa style cho số thứ tự với màu xen kẽ cho từng chữ số
  const stickyNumberBaseStyle = "text-6xl font-black sticky top-40 text-right select-none pointer-events-none";
  const digitGray = "text-gray-400 opacity-30";
  const digitOrange = "text-[#f07d44] opacity-40";
    ...
    <div className="min-h-screen bg-[#eae6e0] text-[#1a1a1a] font-sans selection:bg-[#f07d44] selection:text-white">
      ...
      <section className="relative pt-40 pb-20 px-[5%] max-w-[1600px] mx-auto grid grid-cols-12 gap-6">
        ...
        <div className="col-span-12 lg:col-span-1 hidden lg:block relative">
           <p className={stickyNumberBaseStyle}>
             <span className={digitGray}>0</span>
             <span className={digitOrange}>1</span>
           </p>
        </div>
      ...
      <section className="py-24 px-[5%] max-w-[1600px] mx-auto mb-20 relative">
        <div className="grid grid-cols-12 gap-6">
            ...
            <div className="col-span-12 lg:col-span-1 hidden lg:block relative">
                <p className={stickyNumberBaseStyle}>
                  <span className={digitOrange}>0</span>
                  <span className={digitGray}>2</span>
                </p>
            </div>
      ...
      <section className="py-32 px-[5%] max-w-[1600px] mx-auto relative">
        <div className="grid grid-cols-12 gap-6">
            ...
            <div className="col-span-12 lg:col-span-1 hidden lg:block relative">
                <p className={stickyNumberBaseStyle}>
                  <span className={digitGray}>0</span>
                  <span className={digitOrange}>3</span>
                </p>
            </div>
