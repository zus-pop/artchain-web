...
function createTextTexture(
  ...
  lines.forEach((line, i) => {
    context.font = i === 0 ? titleFont : subFont;
  ...
  context.textAlign = 'left'; // Changed to LEFT align
  context.textBaseline = 'middle';
  
  lines.forEach((line, i) => {
    context.font = i === 0 ? titleFont : subFont;
    context.fillStyle = i === 0 ? color : `${color}aa`; // Lighter for sublines
    const y = padding + (i + 0.5) * lineHeight;
    context.fillText(line, padding, y); // Use padding as X for LEFT align
  });
