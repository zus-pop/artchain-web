                      ...
                      {isUserDropdownOpen && (
                        ...
                        >
                          ...
                          <div className="py-1">
                            ...
                            {displayUser?.wallet && (
                              <Link href="/me/wallet" onClick={() => setIsUserDropdownOpen(false)} className="flex items-center space-x-3 px-4 py-2 text-sm text-gray-700 hover:bg-gray-50">
                            ...
                            <div className="flex-grow flex flex-col">
                              ...
                              <nav className="flex flex-col space-y-4 overflow-y-auto pr-2 pb-6">
                                <Link 
                                  href="/"
                                  onClick={() => setIsMobileMenuOpen(false)}
                                  className="px-5 py-4 rounded-2xl text-lg font-semibold transition-all border shrink-0 text-black bg-black/5 border-black/5 hover:bg-black/10 hover:border-black/10"
                                >
