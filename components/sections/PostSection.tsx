              ...
              >
                ...
                <div className="flex flex-col gap-4 px-2">
                  <Link href={`/posts/${activePost.post_id}`}>
                    <h3 className="text-2xl sm:text-3xl font-bold leading-tight text-[var(--site-ink)] hover:text-[var(--site-accent)] transition-colors">
                      {activePost.title}
                    </h3>
                  </Link>
          ...
          <div className="flex flex-col justify-between h-full">
            <div className="flex flex-col">
              {posts.map((post, idx) => (
                <div 
                  key={post.post_id}
                  className={`relative py-5 px-6 mb-2 rounded-sm transition-all duration-500 cursor-pointer group
                ...
                >
                  ...
                  <div className="flex flex-col gap-2">
                    ...
                    <h4 className={`text-base font-bold transition-colors line-clamp-2
